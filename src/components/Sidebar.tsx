  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-navy text-white">
      ...
      <div className="flex h-16 items-center gap-3 px-5 border-b border-white/10">
        ...
        <div>
          <div className="text-sm font-bold tracking-wide">CONSTELLATION</div>
          <div className="text-[10px] tracking-widest text-white/60 uppercase">Seller Hub</div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-white/60">Connected to Salesforce</span>
        </div>
        <div className="text-[10px] text-white/40 mt-1">Last sync: just now</div>
      </div>
    </aside>
  );
}
